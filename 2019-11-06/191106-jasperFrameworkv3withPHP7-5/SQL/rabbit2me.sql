...
-- 테이블 rabbit2me.board_rabbit2me_filelog 구조 내보내기
CREATE TABLE IF NOT EXISTS `board_rabbit2me_filelog` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `articleId` bigint(20) DEFAULT NULL,
  ...
  `regidate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='// 다운로드 로그';
