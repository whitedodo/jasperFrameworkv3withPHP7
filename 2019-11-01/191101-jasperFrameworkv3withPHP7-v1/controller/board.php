...
class Board{
    ...
    public function view($pageId){
        ...
        if ( $boardState === true && 
            ...
            $commentElem = $boardDB->comment_list($pageId);
            ...
            include './view/board/view/head.php';
            include './view/board/view/body.php';
            include './view/board/view/foot.php';
    ...
    public function comment_write_ok($pageId, $commentElem){
        ...
        if ( $boardState == 1 &&
            ...
            $state === false){
                ...
                include $homeDir . '/view/board/view/head.php';
                include $homeDir . '/view/board/view/body.php';
                include $homeDir . '/view/board/view/foot.php';
